...
\label{cha:intro}
	\section{Project description}
		...
		Second, following the line of achieving a low cost, low sized device the Android system is to act as the host device in the USB communication, thus removing the size-increasing battery requirements for the receiver as the host role provides the power in such communications.\todo{Write a NON GAY conclusion here so it is not the saddest piece of text work ever.}\\
