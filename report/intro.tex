...
\label{cha:intro}
	\section{Project description}
		...
		Taking the aforementioned project as the base, this project seeks taking the beneficial low cost and low power aspects of that to the next level by the employment of a less energy requiring wireless personal area network protocol, namely IEEE 802.15.4, and the more accessible Android based platforms.\\
