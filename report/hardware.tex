...
\label{ch:hardware}
	...
	\label{ssec:USB.FreeRTOS}	
		...
		\begin{enumerate}
			...
			\item \emph{Validate the feasibility of the usage of USB API along with FreeRTOS in MSP430}\\
				...
				instance, the length of the API is about the same size as the code of FreeRTOS. \todo{Remove this last sentence?}
				The most relevant inconvenience that endangers this work is the considerable amount of resources,
				\todo{Question Pferv about this}, which FreeRTOS may need for performing its tasks. However, this
	...
	\label{ssec:802.15.4.FreeRTOS}	
		...
		The amendment of the aforementioned problems takes no longer that expected, and the porting of the 802.14.4 support to the target MSP430 device begins. The original developer of both the FreeRTOS and the MAC layer is notified about the detected problems, and the fixes are also implemented on the 802.15.4 emissor.\todo{this would be jrecas}\\
