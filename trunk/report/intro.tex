...
\label{cha:intro}
	...
	\label{sec:prj-descr}
		...
		Other projects exist with the objective of achieveing 802.15.4 receiving for Android devices \todo{former "similar objectives in mind"}, even if they are not targeted at the field of biometrics and personal monitoring. The reason for not following or employing those is twofold: 
		...
		% Unexplored land of testing!
		\todo{Objectives here?, note they are exposed before}
		% End of the UlT
	...
	\label{sec:prj-oview}
		...
		\todo{Chapter 3. SORWAR!!}

		\todo{Chapter 4. CONCLUSIONS!}