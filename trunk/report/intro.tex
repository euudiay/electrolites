...
\label{cha:intro}
	...
	\label{sec:prj-descr}
		...
		This project exposes the research conducted for the development of an USB 802.15.4 (explained
		at \autoref{ssec:802.15.4}) receiver device for Android based systems employed in a fully 
