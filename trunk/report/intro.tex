...
\label{cha:intro}
	...
	\label{sec:prj-descr}
		...
		Other projects exist with the objective of achieving 802.15.4 receiving for Android devices, even if they are not targeted at the field of biomedics and personal monitoring. The reason for not following or employing those is twofold: 
