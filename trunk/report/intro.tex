...
\label{cha:intro}
	\section{Project description}
		...
		both devices in addition to translating and displaying the transmitted information. In this regard,
		it is also worth of remark that our target displaying device, Xoom tablet from Motorola, incorporates
		the standard Bluetooth module, yet it is not equipped with a ZigBee one. Due to this lack, which is
		more than usual among portable devices nowadays, the making of a compatible receiver accessory
		centers a fairly important part of the projects.\\
