\chapter{Intro}
\label{cha:intro}
	% El orden entre la descripción del proyecto, la motivación y el estado del arte es tentativo.
	...
	\section{State of the art}
		\begin{itemize}
			...
			\item \emph{Communication with Android using ZigBee}\\\\
				...
				\end{itemize}
				%, Android 2.2
				%was employed, instead version 3.1 which is needed in our project so as to get USB host mode support.
				%Besides, it made use of the TI CC2530 SoC, which implements the complete ZigBee stack
		\end{itemize}
