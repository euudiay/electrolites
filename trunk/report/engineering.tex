...
\section{Schematic}
\includegraphics[width=1.5\textwidth,angle=270]{schematic}

\section{PCB}
\includegraphics[scale=0.32]{PCB-3D-Print}\\
\includegraphics[scale=0.32]{Final-Artwork-Prints1}\\
\includegraphics[scale=0.32]{Final-Artwork-Prints2}